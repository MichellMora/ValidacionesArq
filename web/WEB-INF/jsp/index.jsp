	...
	<!-- Brand and toggle get grouped for better mobile display-->
            <div class="navbar-header">
                ...
                <div class="w3layouts-logo">
                    <h1><a href="index.htm">Monitorias <span>UCC</span></a></h1>
		</div>
            </div>
		...
		<nav>
			...
			<li><a href="login.htm" class="hvr-sweep-to-bottom">Entrar</a></li>
			...
			<li><a href="blog.html" class="hvr-sweep-to-bottom">Monitorias</a></li>
                    </ul>
		</nav>
            </div>
	<!-- /.navbar-collapse--> 
