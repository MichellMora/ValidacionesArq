...
<div class="header">
	...
	<div class="about-heading">
		<h2>Bienvenido a la <span> Inscripción de Monitorias</span></h2>
	</div>
        <br><br>
        <center><h3>Para comenzar escoge tu programa academico</h3></center>
        <br><br>
        <div class="signin-form profile">
            <a href="validaciones.htm"><input type="submit" value="PREGRADO"></a>
            <a href="validacionespos.htm"><input type="submit" value="POSGRADO"></a>
        </div>
